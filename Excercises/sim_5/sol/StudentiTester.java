...
class Studenti implements Dictionary {
    ...
    public void insert(Comparable key, Object value) { // precondizioni: controllo anche che i parametri siano del tipo
                                                       // giusto
        ...
        try {
            remove(key);
        } // se la coppia c'e` gia` la rimuovo
        catch (DictionaryItemNotFoundException e) {
        } // altrimenti tutto ok!
    ...
    public void remove(Comparable key) { // uso binSearch per cercare la chiave nell'array non ordinato
    ...
    public Object find(Comparable key) { // uso binSearch per cercare la chiave nell'array non ordinato
                                         // se la chiave non c'e` lancio DictionaryItemNotFoundException come da
                                         // specifiche (viene lanciata da binSearch)
